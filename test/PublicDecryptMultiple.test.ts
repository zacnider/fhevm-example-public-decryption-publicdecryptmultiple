...
import { PublicDecryptMultiple } from "../types";

/**
 * @title PublicDecryptMultiple Tests
 * @notice Comprehensive tests for PublicDecryptMultiple contract
...
describe("PublicDecryptMultiple", function () {
  ...
  async function deployContractFixture() {
    ...
    const ContractFactory = await hre.ethers.getContractFactory("PublicDecryptMultiple");
    ...
    await hre.fhevm.assertCoprocessorInitialized(contract, "PublicDecryptMultiple");
